...
describe('docs/migration/2.5x-settings-auth-storage-field-mapping.md', () => {
  ...
  it("confirmed no-destination auth providers = (2.x provider dirs) - (this repo's modules/authentication/* dirs)", () => {
    ...
    assert.deepEqual(
      [...modules3x].sort(),
      ['github', 'google', 'local', 'oidc'],
      'expected exactly 4 authentication modules in this repo — update the doc if this list changed'
    )
    ...
    assert.equal(noDestination.length, 17)
  })
