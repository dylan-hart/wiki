...
describe('InboxWatching against its design file (#2621)', () => {
  /*
    A `WAvatar` with `identity="plate"` takes its size and shape from the aesthetic's tokens rather
    than from an inline style, so the assertion is the variant class plus the ABSENCE of an inline
    size or `square`.
  */
