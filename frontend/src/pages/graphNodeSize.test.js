 ...
 * pair (`20`/`110` -- the floor doubled from `5` to `10` by OpenProject #2594, then to `20` by
 * OpenProject #2900) rather than arbitrary numbers, so the arithmetic in these comments describes
 * radii the app actually draws.
 */
