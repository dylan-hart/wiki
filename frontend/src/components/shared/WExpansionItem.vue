<template>
  <div class="w-expansion-item">
    <!--
      `select-none`, as `WBtn` carries it: opening a group and closing it again quickly is a double
      click, which otherwise leaves the label text selected behind the group that just shut.
    -->
    <w-item
...
/**
 * Deliberately narrower than the component it replaces: no accordion grouping, lazy rendering,
 * routed header, caption line, side-mounted toggle or transition -- a header row and a body.
 *
