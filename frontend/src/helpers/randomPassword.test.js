...
describe('randomPassword', () => {
  ...
  it('can produce repeated characters (samples with replacement)', () => {
    // With two characters and a 64-long draw, a string holding no adjacent repeat at all would be
    // astronomically unlikely unless the sampling were without replacement.
    const alphabet = 'ab'
