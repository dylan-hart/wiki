...
/**
 * Pure data-shaping logic for `NavEditOverlay.vue`'s menu editor.
 *
 * The overlay keeps the menu it edits as a flat list (`state.items`) so drag-reorder and the nested
