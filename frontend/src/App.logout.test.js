...
// through to the router as if it were a same-origin path. `isSafeLogoutTarget()` replaces the regex
// with the same rule the backend's `helpers/redirectTarget.ts` applies.
