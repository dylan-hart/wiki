...
describe('GET /metrics', () => {
  ...
  test('renders the same Prometheus exposition as the serial version', async () => {
    ...
    assert.ok(
      res.body.startsWith(existingSeries),
    ...
    assert.deepEqual(sampleNames, [
      ...
      'cardinaljs_process_heap_used_bytes',
      'cardinaljs_process_heap_total_bytes',
      'cardinaljs_process_external_memory_bytes',
      'cardinaljs_process_uptime_seconds',
      'cardinaljs_process_cpu_user_seconds_total',
      'cardinaljs_process_cpu_system_seconds_total',
      'cardinaljs_nodejs_eventloop_delay_min_seconds',
      'cardinaljs_nodejs_eventloop_delay_mean_seconds',
      'cardinaljs_nodejs_eventloop_delay_max_seconds',
      'cardinaljs_nodejs_eventloop_delay_p50_seconds',
      'cardinaljs_nodejs_eventloop_delay_p99_seconds'
    ])
