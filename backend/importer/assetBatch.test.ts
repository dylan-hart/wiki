...
/**
 * Integration coverage for `importAssetsInBatches`, run against a throwaway Postgres — same setup as
 * `assets.test.ts`, on the `wiki-test-db-755` container started by hand for this task (never in this
 * file: the test assumes it is already running, and does not manage its lifecycle).
 */
const PORT = 55755
...
describe('importAssetsInBatches', () => {
