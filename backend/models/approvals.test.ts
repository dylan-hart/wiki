...
describe(
  ...
  () => {
    ...
    /** A reviewer scope for `reviewerGroupId`, with `actor`'s rules deciding read:pages/read:source/write:pages. */
    function reviewerScope(actor: AccessActor) {
      return { groupIds: [reviewerGroupId], reviewsAll: false, actor }
    }
