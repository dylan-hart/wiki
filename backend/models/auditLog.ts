...
export const AUDIT_TARGET_TYPES = [
  ...
  'page',
  // -> #2445: `rename_asset`'s (and its `upload_asset`/`delete_asset` siblings') `mcp.writeToolCalled`
  //   target -- an asset, mirroring the `page` target above for the page-write tools.
  'asset',
  'glossaryTerm',
