...
/**
 * Task 2200: a per-user and per-address ceiling on concurrent collaboration sockets, checked and
 ...
 */
describe('(e) connection cap: per-user and per-address ceilings', () => {
  interface FakeConn {
    readyState: number
    OPEN: number
