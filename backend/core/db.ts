...
export default {
   ...
   *
   * All six current subscribers below already tolerate a missed notification, but not for the same
   ...
   *    sixth, and needs no boot-time re-sync at all to close the same gap: its cache is lazily
