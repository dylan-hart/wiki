 ...
 * node/edge assembly + permission-filter logic against a fixture page list with no `CARDINAL` global
 ...
 * have to stand up the `CARDINAL` global just to exercise node/edge assembly. Defaults to the
