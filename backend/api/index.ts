...
export async function registerAllSchemas(app: FastifyInstance) {
  ...
  await import('./schemas/notes.ts').then((m) => m.registerSchemas(app))
  await import('./schemas/notesPromote.ts').then((m) => m.registerSchemas(app))
...
async function routes(app: FastifyInstance) {
  ...
  app.register(async (contentApp) => {
    ...
    contentApp.register(import('./notes.ts'))
    contentApp.register(import('./notesPromote.ts'))
