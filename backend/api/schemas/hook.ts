  ...
  app.addSchema({
    ...
    properties: {
      ...
      acceptUntrusted: {
        type: 'boolean',
        description:
          'Skip TLS certificate validation for this endpoint. When on, and an authHeader is set, the ' +
          'Authorization header is transmitted to a peer whose certificate was never verified.'
      },
      authHeader: {
        type: 'string',
        maxLength: 2048,
