...
describe('mapAuthenticationRow', () => {
  test('local row: config always {} in, fully-defaulted config out, source selfRegistration -> both destination flags', async () => {
    ...
    assert.equal(result.row!.autoProvisioning, true)
