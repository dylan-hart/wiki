 ...
 * asset, delete an asset), page-watch management (watch/unwatch a page, change a watch's delivery
 * preference), and the diagram renderer (site-independent — it draws from posted source, not from any
 * page). Every tool is registered regardless of what `getCtx()` grants —
 ...
 * with no such restriction — see its own doc comment. `watch_page`/`unwatch_page`/
