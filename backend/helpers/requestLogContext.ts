...
/**
 * The slice `helpers/errorHandler.ts`'s bare-500 branch needs: the above, plus the method and URL
 * that the access line already spells out in its own message and so does not repeat as fields.
 */
