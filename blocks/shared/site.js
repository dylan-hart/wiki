 ...
 * (via `../shared/config.js`) were the first to follow this; `block-checklist` (OpenProject #1978)
 * was converted to it for its site id, page id and data fetching. `block-index` and `block-include`
 * still read the SPA globals directly as of this file -- their own conversion is OpenProject #1975.
 *
