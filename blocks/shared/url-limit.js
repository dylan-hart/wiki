 ...
 * alphabet -- with no POST fallback (see `docs/decisions/kroki-plantuml-get-transport.md` for why).
 * That transport has no ceiling of its own; a reverse proxy or server in front of the
